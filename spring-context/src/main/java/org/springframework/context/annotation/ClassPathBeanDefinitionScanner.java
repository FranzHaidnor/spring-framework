...
/*
	一个bean定义扫描程序，用于检测类路径上的bean候选项，并向给定的注册表 (BeanFactory或ApplicationContext) 注册相应的bean定义。
	通过可配置的类型过滤器来检测候选类。默认过滤器包括用 Spring 的 @Component、 @Repository、 @Service @Controller 原型注释的类。
...
public class ClassPathBeanDefinitionScanner extends ClassPathScanningCandidateComponentProvider {
	...
	public ClassPathBeanDefinitionScanner(BeanDefinitionRegistry registry, boolean useDefaultFilters,
		...
		this(registry,
				useDefaultFilters,  // 是否使用默认的 BeanDefinition 过滤器
				environment,
