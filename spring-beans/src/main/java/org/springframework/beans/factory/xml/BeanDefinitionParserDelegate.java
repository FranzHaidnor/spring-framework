 ...
 * 供主解析器和任何扩展 BeanDefinitionParsers 或 BeanDefinitionDecorators 使用
 * <p>
...
public class BeanDefinitionParserDelegate {
	 ...
	 * 自动装配、依赖性检查设置、初始化方法、销毁方法和合并设置。
	 * 通过回退到 {@codeparentDefaults} 支持嵌套的“beans”元素用例
	 * 如果本地未明确设置默认值。
	 *
	 * @param 默认填充的默认值
	 * @paramparentDefaults 父BeanDefinitionParserDelegate（如果有）默认回退到
