...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	...
	public int registerBeanDefinitions(Document doc, Resource resource) throws BeanDefinitionStoreException {
		// 创建 BeanDefinitionDocumentReader 以用于实际从 XML 文档读取 BeanDefinition
		BeanDefinitionDocumentReader documentReader = createBeanDefinitionDocumentReader();

		// 从父类的 BeanDefinitionRegistry registry  bean定义注册器中获取册表中定义的 bean 数量。
		...
		documentReader.registerBeanDefinitions(doc, readerContext);  /** {@link DefaultBeanDefinitionDocumentReader#registerBeanDefinitions(Document, XmlReaderContext)}*/
